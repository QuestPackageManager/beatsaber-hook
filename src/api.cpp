...
void i2c::functions::initialize() noexcept {
    if (initialized) {
        return;
    }
...
[[nodiscard]] void* i2c::gc_alloc_specific(size_t sz) noexcept {
...
[[nodiscard]] void* i2c::gc_realloc_specific(void* ptr, size_t new_size) noexcept {
...
void* i2c::__allocate_unsafe(size_t size) noexcept {

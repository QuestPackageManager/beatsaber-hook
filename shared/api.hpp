...
// These methods autogenerated by Sc2ad:
    ...
    API_FUNC(int, init, (char const* domain_name));
    API_FUNC(int, init_utf16, (Il2CppChar const* domain_name));
#else
    API_FUNC(void, init, (char const* domain_name));
...
#endif
    API_FUNC(Il2CppType const*, class_enum_basetype, (Il2CppClass * klass));
...
#if defined(UNITY_2019) || defined(UNITY_2021) || defined(UNITY_6)
    API_FUNC(void, type_get_name_chunked, (Il2CppType const* type, void (*chunkReportFunc)(void* data, void* userData), void* userData));
#endif
    API_FUNC(char const*, class_get_namespace, (Il2CppClass const* klass));
...
#if defined(UNITY_2019) || defined(UNITY_2021) || defined(UNITY_6)
    API_FUNC(uint32_t, class_get_data_size, (Il2CppClass const* klass));
    API_FUNC(void*, class_get_static_field_data, (Il2CppClass const* klass));
#endif
#if defined(UNITY_2019) || defined(UNITY_2021)
    API_FUNC(size_t, class_get_bitmap_size, (Il2CppClass const* klass));
    API_FUNC(void, class_get_bitmap, (Il2CppClass * klass, size_t* bitmap));
#endif
    API_FUNC(bool, stats_dump_to_file, (char const* path));
...
#endif
    API_FUNC(Il2CppException*, exception_from_name_msg, (Il2CppImage const* image, char const* name_space, char const* name, char const* msg));
...
#endif
    API_FUNC(Il2CppObject*, type_get_object, (Il2CppType const* type));
...
#if defined(UNITY_2019) || defined(UNITY_2021) || defined(UNITY_6)
    API_FUNC(bool, type_is_static, (Il2CppType const* type));
    API_FUNC(bool, type_is_pointer_type, (Il2CppType const* type));
#endif
    API_FUNC(Il2CppAssembly const*, image_get_assembly, (Il2CppImage const* image));
...
#endif
    API_FUNC(void, unity_install_unitytls_interface, (void const* unitytlsInterfaceStruct));
...
#if defined(UNITY_2019) || defined(UNITY_2021) || defined(UNITY_6)
    API_FUNC(std::string, _Type_GetName_, (Il2CppType const* type, Il2CppTypeNameFormat format));
#else
    API_FUNC(gnu_string, _Type_GetName_, (Il2CppType const* type, Il2CppTypeNameFormat format));
#endif
